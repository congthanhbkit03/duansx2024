                    ...
                    <div class="card-body">
                      ...
                      <input type="text" class="form-control" id="madonhang" name="madonhang" value="{{ isset($donhang) ? $donhang->madonhang : '' }}">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div>Mã KH:
                                    <input type="text" id="khachhang_id" name="khachhang_id"
                                        value="{{ isset($donhang) ? $donhang->khachhang_id : '' }}">
                                </div>
                                <ul style="color: blue; font-style: italic; background: #cecece; margin-top: 20px;">
                                    <li>Nếu khách hàng đã tồn tại - nhập từ khóa cần tìm và chọn khách hàng - hoặc nhập trực
                                        tiếp mã Khách hàng vào.</li>
                                    <li>Nếu khách hàng là mới: - Nhấn nút "Thêm mới Khách hàng", điền các thông tin khách
                                        hàng mới và lưu.</li>
                                </ul>
                                <div id="khachhang">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="ngaygiaohang" name="ngaygiaohang"
                                        value="{{ isset($donhang) ? $donhang->ngaygiaohang : '' }}">
                                </div>
                            </div>
                            <div class="col"></div>
                        </div>
